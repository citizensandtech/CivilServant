...
python schedule_twitter_jobs.py --function fetch_twitter_tweets --statuses_backfill --interval 1800 --n_tasks $1 2> $logfile

echo "Fetch Twitter Tweets: Every 30 mins"
python schedule_twitter_jobs.py --function fetch_twitter_tweets --interval 1800 --n_tasks $1 2> $logfile
