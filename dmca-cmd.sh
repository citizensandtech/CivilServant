...
python schedule_twitter_jobs.py --function fetch_twitter_tweets --statuses_backfill --interval 43200 2> logfile

# Fetch Twitter Tweets: Every twenty-four hours (once a day)
echo "Fetch Twitter Tweets: Every twenty-four hours (once a day)"
python schedule_twitter_jobs.py --function fetch_twitter_tweets --interval 86400 --n_tasks 2 2> logfile
