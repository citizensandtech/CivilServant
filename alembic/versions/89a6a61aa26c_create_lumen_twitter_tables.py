"""create_lumen_twitter_tables

Revision ID: 89a6a61aa26c
Revises: 757925d8e6eb
Create Date: 2017-05-12 04:46:53.229688

"""

# revision identifiers, used by Alembic.
revision = '89a6a61aa26c'
down_revision = '757925d8e6eb'
branch_labels = None
depends_on = None
...
def upgrade_development():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('twitter_user_id', sa.String(length=64), nullable=True),
    sa.Column('twitter_not_found_id', sa.String(length=64), nullable=True),
    sa.Column('record_created_at', sa.DateTime(), nullable=True),
    sa.Column('user_state', sa.Integer(), nullable=True),
    sa.Column('user_json', mysql.MEDIUMTEXT(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_twitter_user_snapshots_twitter_not_found_id'), 'twitter_user_snapshots', ['twitter_not_found_id'], unique=False)
    ...
    sa.Column('not_found_id', sa.String(length=64), nullable=True),
    ...
    op.create_index(op.f('ix_twitter_users_not_found_id'), 'twitter_users', ['not_found_id'], unique=False)
