...
def upgrade_test():
    ...
    op.drop_column('twitter_user_snapshots', 'statuses_count')
    op.drop_column('twitter_user_snapshots', 'verified')
    op.drop_column('twitter_user_snapshots', 'created_at')
    op.drop_column('twitter_user_snapshots', 'followers_count')
    op.drop_column('twitter_user_snapshots', 'friends_count')
    # ### end Alembic commands ###


def downgrade_test():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('twitter_user_snapshots', sa.Column('friends_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.add_column('twitter_user_snapshots', sa.Column('followers_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.add_column('twitter_user_snapshots', sa.Column('created_at', mysql.DATETIME(), nullable=True))
    op.add_column('twitter_user_snapshots', sa.Column('verified', mysql.TINYINT(display_width=1), autoincrement=False, nullable=True))
    op.add_column('twitter_user_snapshots', sa.Column('statuses_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.drop_column('twitter_user_snapshots', 'record_created_at')
    op.drop_index(op.f('ix_twitter_users_screen_name'), table_name='twitter_users')
    op.drop_table('twitter_users')
    op.drop_index(op.f('ix_twitter_statuses_user_id'), table_name='twitter_statuses')
    op.drop_table('twitter_statuses')
